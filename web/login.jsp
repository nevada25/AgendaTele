 ...
 <script>
  alertify.<%=alert%>("<%=mensaje%>");
        ...
        <div class="lc-block" id="l-register">
            <form action="ControlLoginSvt?acciones=AGREGAR" method="post">
            <div class="input-group m-b-20">
                <span class="input-group-addon "><i class="md md-person"></i></span>
                <div class="fg-line">
                    <input type="text" class="form-control text-center" name="usuario" placeholder="INGRESE SU USUARIO">
            ...
            <div class="clearfix"></div>
            <button href="#" type="submit" class="btn btn-login btn-danger btn-float waves-effect waves-button waves-float"><i class="md md-arrow-forward"></i></button>
